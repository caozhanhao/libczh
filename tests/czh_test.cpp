...
namespace czh::test
{
  ...
  LIBCZH_TEST(czh)
  {
    ...
    LIBCZH_EXPECT_EQ(nodetest["czh"]["block"]["a"].get<int>(), 200000000);
    LIBCZH_EXPECT_EQ(nodetest["czh"]["block"]["b"].get<int>(), 0);
    LIBCZH_EXPECT_EQ(nodetest["czh"]["block"]["c"].get<int>(), 200000000);
    LIBCZH_EXPECT_EQ(nodetest["czh"]["block"]["d"].get<int>(), 200000000);
    ...
    std::stringstream ss;
    writer::PrettyWriter<std::stringstream> pw{ss};
    nodetest.accept(pw);
    LIBCZH_EXPECT_EQ(ss.str(),
